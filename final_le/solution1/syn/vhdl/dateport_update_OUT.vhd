...
architecture behav of dateport_update_OUT is 
    ...
    signal tmp_207_fu_220_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_205_fu_185_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_206_fu_197_p3 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    dateport_fadd_32ns_32ns_32_5_full_dsp_U101 : component dateport_fadd_32ns_32ns_32_5_full_dsp
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    dateport_fmul_32ns_32ns_32_4_max_dsp_U102 : component dateport_fmul_32ns_32ns_32_4_max_dsp
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6)) then
                output_dwei_addr_reg_283 <= tmp_207_fu_220_p1(9 - 1 downto 0);
            end if;
        end if;
    end process;
    ...
    output_dwei_address0_assign_proc : process(output_dwei_addr_reg_283, ap_sig_cseq_ST_st7_fsm_6, ap_sig_cseq_ST_st14_fsm_13, tmp_207_fu_220_p1)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st14_fsm_13)) then 
            output_dwei_address0 <= output_dwei_addr_reg_283;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6)) then 
            output_dwei_address0 <= tmp_207_fu_220_p1(9 - 1 downto 0);
        else 
    ...
    p_shl3_cast_fu_205_p1 <= std_logic_vector(resize(unsigned(tmp_206_fu_197_p3),9));
    p_shl_cast_fu_193_p1 <= std_logic_vector(resize(unsigned(tmp_205_fu_185_p3),9));
    tmp_105_fu_180_p1 <= std_logic_vector(resize(unsigned(j_reg_104),64));
    tmp_205_fu_185_p3 <= (j_reg_104 & ap_const_lv3_0);
    tmp_206_fu_197_p3 <= (j_reg_104 & ap_const_lv1_0);
    tmp_207_fu_220_p1 <= std_logic_vector(resize(unsigned(output_dwei_addr2_reg_268),64));
