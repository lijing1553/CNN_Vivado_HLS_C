set moduleName dateport_DS2_layer
...
set isOneStateSeq 0
set C_modelName {dateport_DS2_layer}
set C_modelType { void 0 }
set C_modelArgList { 
	{ S2_d float 32 regular {array 1176 { 2 3 } 1 1 } {global 2}  }
	{ C3_d float 32 regular {array 1600 { 1 3 } 1 1 } {global 0}  }
	{ C3_mapData float 32 regular {array 2400 { 1 1 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "S2_d", "interface" : "memory", "bitwidth" : 32 ,"direction" : "READWRITE" ,"extern" : 0} , 
...
set portList { 
	...
	{ S2_d_address0 sc_out sc_lv 11 signal 0 } 
	{ S2_d_ce0 sc_out sc_logic 1 signal 0 } 
	{ S2_d_we0 sc_out sc_logic 1 signal 0 } 
	{ S2_d_d0 sc_out sc_lv 32 signal 0 } 
	{ S2_d_q0 sc_in sc_lv 32 signal 0 } 
	{ C3_d_address0 sc_out sc_lv 11 signal 1 } 
	{ C3_d_ce0 sc_out sc_logic 1 signal 1 } 
	{ C3_d_q0 sc_in sc_lv 32 signal 1 } 
	{ C3_mapData_address0 sc_out sc_lv 12 signal 2 } 
	{ C3_mapData_ce0 sc_out sc_logic 1 signal 2 } 
	{ C3_mapData_q0 sc_in sc_lv 32 signal 2 } 
	{ C3_mapData_address1 sc_out sc_lv 12 signal 2 } 
	{ C3_mapData_ce1 sc_out sc_logic 1 signal 2 } 
	{ C3_mapData_q1 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "S2_d_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "S2_d", "role": "we0" }} , 
 	{ "name": "S2_d_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "S2_d", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	S2_d { ap_memory {  { S2_d_address0 mem_address 1 11 }  { S2_d_ce0 mem_ce 1 1 }  { S2_d_we0 mem_we 1 1 }  { S2_d_d0 mem_din 1 32 }  { S2_d_q0 mem_dout 0 32 } } }
	C3_d { ap_memory {  { C3_d_address0 mem_address 1 11 }  { C3_d_ce0 mem_ce 1 1 }  { C3_d_q0 mem_dout 0 32 } } }
