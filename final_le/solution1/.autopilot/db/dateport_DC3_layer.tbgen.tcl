set moduleName dateport_DC3_layer
...
set isOneStateSeq 0
set C_modelName {dateport_DC3_layer}
set C_modelType { void 0 }
set C_modelArgList { 
	{ C3_bias float 32 regular {array 16 { 1 3 } 1 1 } {global 0}  }
	{ S4_d float 32 regular {array 400 { 1 3 } 1 1 } {global 0}  }
	{ C3_y float 32 regular {array 1600 { 1 1 } 1 1 } {global 0}  }
	{ C3_d float 32 regular {array 1600 { 0 0 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "C3_bias", "interface" : "memory", "bitwidth" : 32 ,"direction" : "READONLY" ,"extern" : 0} , 
 	{ "Name" : "S4_d", "interface" : "memory", "bitwidth" : 32 ,"direction" : "READONLY" ,"extern" : 0} , 
 	{ "Name" : "C3_y", "interface" : "memory", "bitwidth" : 32 ,"direction" : "READONLY" ,"extern" : 0} , 
 	{ "Name" : "C3_d", "interface" : "memory", "bitwidth" : 32 ,"direction" : "WRITEONLY" ,"extern" : 0} ]}
...
set portList { 
	...
	{ C3_bias_address0 sc_out sc_lv 4 signal 0 } 
	{ C3_bias_ce0 sc_out sc_logic 1 signal 0 } 
	{ C3_bias_q0 sc_in sc_lv 32 signal 0 } 
	{ S4_d_address0 sc_out sc_lv 9 signal 1 } 
	{ S4_d_ce0 sc_out sc_logic 1 signal 1 } 
	{ S4_d_q0 sc_in sc_lv 32 signal 1 } 
	{ C3_y_address0 sc_out sc_lv 11 signal 2 } 
	{ C3_y_ce0 sc_out sc_logic 1 signal 2 } 
	{ C3_y_q0 sc_in sc_lv 32 signal 2 } 
	{ C3_y_address1 sc_out sc_lv 11 signal 2 } 
	{ C3_y_ce1 sc_out sc_logic 1 signal 2 } 
	{ C3_y_q1 sc_in sc_lv 32 signal 2 } 
	{ C3_d_address0 sc_out sc_lv 11 signal 3 } 
	{ C3_d_ce0 sc_out sc_logic 1 signal 3 } 
	{ C3_d_we0 sc_out sc_logic 1 signal 3 } 
	{ C3_d_d0 sc_out sc_lv 32 signal 3 } 
	{ C3_d_address1 sc_out sc_lv 11 signal 3 } 
	{ C3_d_ce1 sc_out sc_logic 1 signal 3 } 
	{ C3_d_we1 sc_out sc_logic 1 signal 3 } 
	{ C3_d_d1 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "C3_d_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "C3_d", "role": "we0" }} , 
 	{ "name": "C3_d_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "C3_d", "role": "d0" }} , 
 	...
 	{ "name": "C3_d_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "C3_d", "role": "we1" }} , 
 	{ "name": "C3_d_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "C3_d", "role": "d1" }}  ]}
set Spec2ImplPortList { 
	C3_bias { ap_memory {  { C3_bias_address0 mem_address 1 4 }  { C3_bias_ce0 mem_ce 1 1 }  { C3_bias_q0 mem_dout 0 32 } } }
	S4_d { ap_memory {  { S4_d_address0 mem_address 1 9 }  { S4_d_ce0 mem_ce 1 1 }  { S4_d_q0 mem_dout 0 32 } } }
	...
	C3_d { ap_memory {  { C3_d_address0 mem_address 1 11 }  { C3_d_ce0 mem_ce 1 1 }  { C3_d_we0 mem_we 1 1 }  { C3_d_d0 mem_din 1 32 }  { C3_d_address1 mem_address 1 11 }  { C3_d_ce1 mem_ce 1 1 }  { C3_d_we1 mem_we 1 1 }  { C3_d_d1 mem_din 1 32 } } }
}
