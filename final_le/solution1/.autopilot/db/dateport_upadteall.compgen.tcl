...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename C3_mapData \
    op interface \
    ports { C3_mapData_address0 { O 12 vector } C3_mapData_ce0 { O 1 bit } C3_mapData_q0 { I 32 vector } C3_mapData_address1 { O 12 vector } C3_mapData_ce1 { O 1 bit } C3_mapData_we1 { O 1 bit } C3_mapData_d1 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { C3_dmapData_address0 { O 12 vector } C3_dmapData_ce0 { O 1 bit } C3_dmapData_q0 { I 32 vector } C3_dmapData_address1 { O 12 vector } C3_dmapData_ce1 { O 1 bit } C3_dmapData_we1 { O 1 bit } C3_dmapData_d1 { O 32 vector } } \
} "
} else {
