...
set C_modelArgList { 
	...
	{ C3_mapData float 32 regular {array 2400 { 2 3 } 1 1 } {global 2}  }
...
set portList { 
	...
	{ C3_mapData_we0 sc_out sc_logic 1 signal 4 } 
	{ C3_mapData_d0 sc_out sc_lv 32 signal 4 } 
	...
	{ C3_dmapData_we0 sc_out sc_logic 1 signal 5 } 
	{ C3_dmapData_d0 sc_out sc_lv 32 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "C3_mapData_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "C3_mapData", "role": "we0" }} , 
 	{ "name": "C3_mapData_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "C3_mapData", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	...
	C3_mapData { ap_memory {  { C3_mapData_address0 mem_address 1 12 }  { C3_mapData_ce0 mem_ce 1 1 }  { C3_mapData_we0 mem_we 1 1 }  { C3_mapData_d0 mem_din 1 32 }  { C3_mapData_q0 mem_dout 0 32 } } }
