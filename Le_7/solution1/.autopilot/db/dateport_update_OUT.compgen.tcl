...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_d \
    op interface \
    ports { output_d_address0 { O 4 vector } output_d_ce0 { O 1 bit } output_d_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'output_d'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename C5_y \
    op interface \
    ports { C5_y_address0 { O 5 vector } C5_y_ce0 { O 1 bit } C5_y_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'C5_y'"
}
}
